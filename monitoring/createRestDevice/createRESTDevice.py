...
# parser.add_argument('-ip',help='192.168.1.6', required=True)
# parser.add_argument('-devip',help='192.168.1.6', required=True)

# args=vars(parser.parse_args())

edgex_ip    = '172.20.192.1'
device_ip   = '127.0.0.1'
...
def createDeviceService():
    ...
    payload = {
        "name":"dummy-rest-device-service3",
